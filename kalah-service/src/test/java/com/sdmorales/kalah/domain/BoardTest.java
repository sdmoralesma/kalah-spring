...
class BoardTest {
    ...
    void moveOneStoneOnPit1ForNorthPlayerOk() {
        Map<Integer, Integer> result = board.move(1, Orientation.NORTH);
    ...
    void moveOneStoneOnPit3ForNorthPlayerOk() {
        Map<Integer, Integer> result = board.move(3, Orientation.NORTH);
    ...
    void moveOneStoneOnPit8ForSouthPlayerOk() {
        Map<Integer, Integer> result = board.move(8, Orientation.SOUTH);
    ...
    void moveOneStoneOnPit10ForSouthPlayerOk() {
        Map<Integer, Integer> result = board.move(10, Orientation.SOUTH);
